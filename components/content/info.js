            ...
            <View style={{flex: 1}}>
                ...
                <View style={{flex: 1, flexDirection: 'row', marginTop: 15}}>
                    <View style={[globalStyles.roundedShadedView, {marginLeft: 30, marginRight: 5, flex: 1}]}>
                        ...
                        <Text style={[globalStyles.regularText, {fontSize: 10, textAlign: 'center'}]}>{'Weet altijd waar \n u zich bevindt'}</Text>
                    </View>
                    <View style={[globalStyles.roundedShadedView, {marginLeft: 5, marginRight: 30, flex: 1}]}>
                        ...
                        <Text style={[globalStyles.titleText, {fontSize: 15, textAlign: 'center', marginTop: 5}]}>COUPONS</Text>
                        <Text style={[globalStyles.regularText, {fontSize: 10, textAlign: 'center'}]}>{'Hoeveel coupons \n heb ik nog?'}</Text>
                    </View>
                </View>
